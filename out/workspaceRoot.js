...
exports.resolveHarnessWorkspaceRoot = resolveHarnessWorkspaceRoot;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
function resolveHarnessWorkspaceRoot(openedWorkspacePath) {
...
function isHarnessProjectRoot(targetPath) {
