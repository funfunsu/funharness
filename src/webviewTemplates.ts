import { Config, PromptConfig, STAGE, SubTask, Task, TaskStats } from './models';
...
export function buildMainPageHtml(
    ...
    config: { compactTaskDecomposition: boolean; isWorktreeSubview: boolean; frontendStartCmd: string; backendStartCmd: string }
): string {
